...
const MICRO_APP_ENV_INFO = {
  __MICRO_APP_ENVIRONMENT__: {
    ...
    url: 'https://jd-opensource.github.io/micro-app/docs.html#/zh-cn/env?id=__micro_app_environment__',
  },
  __MICRO_APP_NAME__: {
    describe: '应用名称',
    url: 'https://jd-opensource.github.io/micro-app/docs.html#/zh-cn/env?id=__micro_app_name__',
  },
  __MICRO_APP_PUBLIC_PATH__: {
    describe: '子应用的静态资源前缀',
    url: 'https://jd-opensource.github.io/micro-app/docs.html#/zh-cn/env?id=__micro_app_public_path__',
  },
  __MICRO_APP_URL__: {
    describe: '子应用的网址',
    url: 'https://jd-opensource.github.io/micro-app/docs.html#/zh-cn/env?id=__micro_app_base_route__',
  },
  ...
  __MICRO_APP_SANDBOX_TYPE__: {
    describe: '子应用沙箱模式',
    url: 'https://jd-opensource.github.io/micro-app/docs.html#/zh-cn/configure?id=iframe',
  },
  __MICRO_APP_UMD_MODE__: {
    describe: '是否开启UMD模式',
    url: 'https://jd-opensource.github.io/micro-app/docs.html#/zh-cn/framework/vue?id=_1%e3%80%81%e5%bc%80%e5%90%afumd%e6%a8%a1%e5%bc%8f%ef%bc%8c%e4%bc%98%e5%8c%96%e5%86%85%e5%ad%98%e5%92%8c%e6%80%a7%e8%83%bd',
  },
  __MICRO_APP_PRE_RENDER__: {
    describe: '是否开启预渲染',
    url: 'https://jd-opensource.github.io/micro-app/docs.html#/zh-cn/router',
  },
  __MICRO_APP_BASE_APPLICATION__: {
    describe: '是否是主应用',
    url: 'https://jd-opensource.github.io/micro-app/docs.html#/zh-cn/env?id=__micro_app_base_application__',
  },
  __MICRO_APP_STATE__: {
    describe: '基座中获取子应用的状态',
    url: 'https://jd-opensource.github.io/micro-app/docs.html#/zh-cn/changelog?id=_100-rc3',
  },
};
...
class Environment extends React.PureComponent<DevToolsPageProps, DevToolsPageState> {
  ...
  private openUrl = (record) => {
    const url = record.url || 'https://jd-opensource.github.io/micro-app/docs.html#/zh-cn/env';
